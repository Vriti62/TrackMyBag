...
const storage = multer.diskStorage({
  destination: (req, file, cb) => {
    ...
    const dest = file.fieldname === 'profile-picture' ? profilePictureDir : uploadDir;
    cb(null, dest);
  },
...
app.put("/api/users/:id/profile-picture", upload.single('profile-picture'), userController.updateProfilePicture); // Upload profile picture
